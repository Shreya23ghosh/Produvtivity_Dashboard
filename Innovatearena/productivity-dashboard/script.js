...
//         console.log(motivationQuoteContent, motivationAuthor);
//     }
...
function weatherFunctionality() {
    ...
    async function weatherAPICall() {
        var response =  fetch(`https://api.weatherapi.com/v1/current.json?key=${apiKey}&q=${city}`)
...
function renderGoals(){
    ...
    goals.forEach(function(goal,index){
        ...
        sum += `
        <div class="goal-item">
            <h4 style="text-decoration:${goal.done ? 'line-through':'none'}">
                ${goal.text}
            </h4>
